<div class="row">
    <div class="col-lg-12">
        ...
        <!--expirey date-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.expiry_date'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm pickadate" autocomplete="off"
                    name="bill_expiry_date_add_edit" value="<?php echo e(runtimeDatepickerDate($estimate->bill_expiry_date ?? '')); ?>"
                    autocomplete="off">
...
</div><?php /**PATH /var/www/html/application/resources/views/pages/estimates/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>