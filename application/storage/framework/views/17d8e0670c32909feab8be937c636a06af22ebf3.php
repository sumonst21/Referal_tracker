...
<div class="x-reference">
        <a href="<?php echo e(url('projects/'.$event->event_parent_id.'/tasks')); ?>"> (<?php echo e(runtimeLang($event->event_parent_type)); ?>
...
<div class="x-reference">
        <a href="<?php echo e(url('projects/'.$event->event_parent_id.'/invoices')); ?>">
                (<?php echo e(runtimeLang($event->event_parent_type)); ?>
...
<div class="x-reference">
        <a href="<?php echo e(url('projects/'.$event->event_parent_id.'/files')); ?>"> (<?php echo e(runtimeLang($event->event_parent_type)); ?>
...
<div class="x-reference">
        <a href="<?php echo e(url('projects/'.$event->event_parent_id.'/estimates')); ?>">
                (<?php echo e(runtimeLang($event->event_parent_type)); ?>
...
<div class="x-reference">
        <a href="<?php echo e(url('projects/'.$event->event_parent_id.'/comments')); ?>">
                (<?php echo e(runtimeLang($event->event_parent_type)); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/application/resources/views/pages/events/includes/parent.blade.php ENDPATH**/ ?>