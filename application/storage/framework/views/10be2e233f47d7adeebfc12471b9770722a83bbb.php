        ...
        <div class="card-body p-l-15 p-r-15">
            <div class="d-flex p-10 no-block">
                <span class="align-slef-center card-4">
                    ...
                    <h6 class="text-info m-b-0"><?php echo e(cleanLang(__('lang.invoices'))); ?> - <?php echo e(cleanLang(__('lang.overdue'))); ?></h6>
                </span>
...
</div><?php /**PATH /var/www/html/application/resources/views/pages/home/client/widgets/first-row/invoices-overdue.blade.php ENDPATH**/ ?>