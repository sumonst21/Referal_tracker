        ...
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="tasks-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10"
                ...
                <tbody id="tasks-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.c_tasks.components.table.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
</div><?php /**PATH /var/www/html/application/resources/views/pages/c_tasks/components/table/table.blade.php ENDPATH**/ ?>