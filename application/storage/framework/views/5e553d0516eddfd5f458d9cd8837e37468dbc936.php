        ...
        <div class="card-body p-l-15 p-r-15">
            <div class="d-flex p-10 no-block">
                <span class="align-slef-center card-3">
                    ...
                    <h6 class="text-warning m-b-0"><?php echo e(cleanLang(__('lang.invoices'))); ?> - <br><?php echo e(cleanLang(__('lang.due'))); ?></h6>
                </span>
...
</div><?php /**PATH /var/www/html/application/resources/views/pages/home/client/widgets/first-row/invoices-due.blade.php ENDPATH**/ ?>