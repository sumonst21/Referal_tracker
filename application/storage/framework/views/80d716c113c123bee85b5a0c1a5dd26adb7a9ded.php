...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9  <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.delete_estimate'))); ?>"
            ...
            data-confirm-title="<?php echo e(cleanLang(__('lang.delete_estimate'))); ?>" data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>"
            data-ajax-type="DELETE" data-url="<?php echo e(url('/')); ?>/estimates/<?php echo e($bill->bill_estimateid); ?>?source=page"><i
...
</div><?php /**PATH /var/www/html/application/resources/views/pages/bill/components/misc/estimate/actions.blade.php ENDPATH**/ ?>