...
<span id="js-trigger-general-timers" class="hidden" id="timerPollingTrigger" data-type="form" data-progress-bar='hidden' data-notifications="disabled"
...
<span id="js-trigger-force-password-change" class="hidden edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
    ...
    data-header-visibility="hidden" data-close-button-visibility="hidden"
    data-action-ajax-loading-target="commonModalBody"></span>
<?php endif; ?><?php /**PATH /home/devindiit/public_html/retainify_dev/application/resources/views/layout/automationjs.blade.php ENDPATH**/ ?>