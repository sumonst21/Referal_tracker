    ...
    <div class="col-12">
        <div class="dropzone dz-clickable text-center file-upload-box" id="fileupload_avatar">
            <div class="dz-default dz-message">
                ...
                <div class=""><small><?php echo e(cleanLang(__('lang.minimum_size'))); ?>: (80 x 80)  - <?php echo e(cleanLang(__('lang.maximum_size'))); ?>: (500 x 500)</small></div>
            </div>
        </div>
    </div>
</div><?php /**PATH /var/www/html/application/resources/views/pages/user/modals/update-avatar.blade.php ENDPATH**/ ?>