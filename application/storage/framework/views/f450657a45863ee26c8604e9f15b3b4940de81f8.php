<div class="row">
    <div class="col-lg-12">
        ...
        <!--assigned [roles]-->
        <?php if(auth()->user()->role->role_assign_tasks == 'yes'): ?>
        <div class="form-group row">
            <label
...
</div><?php /**PATH /var/www/html/application/resources/views/pages/tasks/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>