...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.show_archive_tasks')) }}"
            ...
            data-url="{{ url('/tasks/search?action=search&toggle=pref_filter_show_archived_tasks') }}">
        ...
        <!--show archived items-->
        @if(config('visibility.archived_leads_toggle_button'))
        ...
        <button type="button"
            class="btn btn-danger btn-add-circle edit-add-modal-button js-ajax-ux-request reset-target-modal-form {{ $page['add_button_classes'] ?? '' }}  action-class-{{ $page['page'] ?? '' }}"
