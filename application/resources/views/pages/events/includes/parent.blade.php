...
<div class="x-reference">
        <a href="{{ url('projects/'.$event->event_parent_id.'/tasks') }}"> ({{ runtimeLang($event->event_parent_type) }}
                #{{ $event->event_parent_id }}) -
...
<div class="x-reference">
        <a href="{{ url('projects/'.$event->event_parent_id.'/invoices') }}">
                ({{ runtimeLang($event->event_parent_type) }}
                #{{ $event->event_parent_id }}) -
                {{ $event->event_parent_title }}</a></div>
@endif
...
<div class="x-reference">
        <a href="{{ url('projects/'.$event->event_parent_id.'/files') }}"> ({{ runtimeLang($event->event_parent_type) }}
                #{{ $event->event_parent_id }}) -
                {{ $event->event_parent_title }}</a></div>
@endif
...
<div class="x-reference">
        <a href="{{ url('projects/'.$event->event_parent_id.'/estimates') }}">
                ({{ runtimeLang($event->event_parent_type) }}
                #{{ $event->event_parent_id }}) -
                {{ $event->event_parent_title }}</a></div>
@endif
...
<div class="x-reference">
        <a href="{{ url('projects/'.$event->event_parent_id.'/comments') }}">
                ({{ runtimeLang($event->event_parent_type) }}
                #{{ $event->event_parent_id }}) -
                {{ $event->event_parent_title }}</a></div>
@endif
