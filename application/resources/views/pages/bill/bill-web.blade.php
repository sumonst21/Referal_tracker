<div id="bill-form-container">
    <div class="card card-body invoice-wrapper box-shadow" id="invoice-wrapper">
            ...
            <div class="col-12">
                ...
                <div class="p-t-25 invoice-pay" id="invoice-buttons-container">
                    <div class="text-right">
                        ...
                        <button class="btn btn-danger" id="invoice-make-payment-button"> {{ cleanLang(__('lang.make_a_payment')) }} </button>
                        @endif
                        ...
                        <button class="buttons-accept-decline btn btn-danger confirm-action-danger"
                            ...
                            data-confirm-text="{{ cleanLang(__('lang.decline_estimate_confirm')) }}" data-ajax-type="GET"
                ...
                <div class="col-12">
                    ...
                    <div class="text-right p-t-25">
                        ...
                        <button class="btn btn-info btn-sm js-elements-popover-button" tabindex="0"
                            ...
                            data-popover-content="{{ $elements['tax_popover'] }}" data-title="{{ cleanLang(__('lang.tax_rates')) }}">
                        ...
                        <button class="btn btn-success btn-sm js-elements-popover-button" tabindex="0"
                            ...
                            data-popover-content="{{ $elements['discount_popover'] }}"> {{ cleanLang(__('lang.discounts')) }}
                        </button>
                        @if($bill->bill_type == 'invoice')
                        <!--cancel-->
        ...
        @if(config('visibility.bill_mode') == 'viewing')
        <div class="card card-body invoice-wrapper box-shadow" id="invoice-wrapper">
            <h4 class="">{{ cleanLang(__('lang.notes')) }} <span class="align-middle text-themecontrast font-16" data-toggle="tooltip"
