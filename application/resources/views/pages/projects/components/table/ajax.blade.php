...
<tr id="project_{{ $project->project_id }}">
    ...
    <td class="projects_col_id">
        <a href="/projects/{{ $project->project_id }}">{{ $project->project_id }}</label></a>
    </td>
    <td class="projects_col_project">
        <a href="/projects/{{ $project->project_id }}">{{ str_limit($project->project_title ??'---', 20) }}<a />
    </td>
    ...
    <td class="projects_col_status">
        ...
        <span
            class="label label-outline-gray">@lang('lang.archived')</span></span>
        </span>
        @endif
    </td>
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            @endif
            <!--view-->
            <a href="/projects/{{ $project->project_id }}" title="{{ cleanLang(__('lang.view')) }}"
