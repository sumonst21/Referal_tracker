...
<div class="kanban-card show-modal-button reset-card-modal-form js-ajax-ux-request" data-toggle="modal"
    ...
    <div class="x-footer row">
        <div class="col-6 x-icons">
            ...
            <span class="x-icon {{ runtimeActivateOrAchive('archived-icon', $task->task_active_state) }}" id="archived_icon_{{ $task->task_id }}" data-toggle="tooltip"
                title="@lang('lang.archived')"><i class="ti-archive font-15"></i></span>
            @endif
