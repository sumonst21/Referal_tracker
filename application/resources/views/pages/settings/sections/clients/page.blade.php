...
<form class="form">
    ...
    <div>
        ...
        <a href="https://growcrm.io/documentation/client-settings/"  target="_blank" class="btn btn-sm btn-info help-documentation"><i class="ti-info-alt"></i> {{ cleanLang(__('lang.help_documentation')) }}</a>
    </div>
    <!--buttons-->
