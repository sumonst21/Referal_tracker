        ...
        <table id="custom-fields" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10"">
            <thead>
                <tr>
                    ...
                    <th class=" w-15">{{ cleanLang(__('lang.show_profile')) }}</th>
            <th class="w-15">{{ cleanLang(__('lang.show_invoice')) }}</th>
            <th class="w-13">{{ cleanLang(__('lang.required')) }}</th>
            ...
            <tbody id="status-td-container">
                ...
                <tr>
                    ...
                    <td class="td-checkbox">
                        <input type="checkbox" id="customfields_show_client_page[{{ $field->customfields_id }}]"
                            name="customfields_show_client_page[{{ $field->customfields_id }}]"
                            class="filled-in chk-col-light-blue"
                            {{ runtimePrechecked($field->customfields_show_client_page) }}>
                        <label for="customfields_show_client_page[{{ $field->customfields_id }}]"></label>
                    </td>
                    <!--show on invoice-->
                    <td class="td-checkbox">
                        <input type="checkbox" id="customfields_show_invoice[{{ $field->customfields_id }}]"
                            name="customfields_show_invoice[{{ $field->customfields_id }}]"
                            class="filled-in chk-col-light-blue"
                            {{ runtimePrechecked($field->customfields_show_invoice) }}>
                        <label for="customfields_show_invoice[{{ $field->customfields_id }}]"></label>
                    </td>
                    <!--required-->
                    <td class="td-checkbox">
