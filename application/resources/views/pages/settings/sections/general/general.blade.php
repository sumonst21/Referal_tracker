...
<form class="form" id="settingsFormGeneral">
    ...
    <!--timezone-->
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.timezone')) }}</label>
        <div class="col-12">
    ...
    <!--date format-->
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.date_format')) }}</label>
        <div class="col-12">
    ...
    <!--date pickerformat-->
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.date_picker_format')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.left_menu_position')) }}</label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_default_leftmenu"
                ...
                <option value="open" {{ runtimePreselected('open', $settings->settings_system_default_leftmenu ?? '') }}>
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.stats_panel_default')) }}</label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_default_statspanel"
                ...
                <option value="collapsed"
                    ...
                    {{ cleanLang(__('lang.collapsed')) }}</option>
                <option value="open" {{ runtimePreselected('open', $settings->settings_system_default_statspanel ?? '') }}>
                    {{ cleanLang(__('lang.open')) }}</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.close_modal_windows_on_page_click')) }}</label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_close_modals_body_click"
                ...
                <option value="no" {{ runtimePreselected('no', $settings->settings_system_close_modals_body_click ?? '') }}>
    ...
    <!--system language-->
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.default_language')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.allow_users_to_change_language')) }}</label>
        <div class="col-12">
