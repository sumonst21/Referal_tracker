<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="reminders-checkbox-actions-container">
    <!--button-->
    ...
    <div class="x-buttons">
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger" 
                data-type="form"
                data-ajax-type="POST" 
                data-form-id="reminders-list-table" 
                data-url="{{ url('/reminders/delete?type=bulk') }}"
                data-confirm-title="{{ cleanLang(__('lang.delete_selected_items')) }}" 
                data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}"
                id="checkbox-actions-delete-reminders">
