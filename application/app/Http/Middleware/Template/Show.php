...
class Show {
    ...
    public function handle($request, Closure $next) {
        ...
        //permission denied
        Log::error("permission denied", ['process' => '[permissions][foos][show]', 'ref' => config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
        abort(403);
    }
