...
class Timer {
     ...
     *
     */
    public function __construct(C_TaskPermissions $c_task_permissions, ProjectPermissions $project_permissions) {
        $this->c_task_permissions = $c_task_permissions;
