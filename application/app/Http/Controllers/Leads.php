...
use App\Http\Responses\Leads\updateCustomFieldsResponse;
...
class Leads extends Controller {
    ...
    public function create(CategoryRepository $categoryrepo) {
        ...
        $payload = [
            ...
            'sources' => $sources,
            'stats' => $this->statsWidget(),
            'fields' => \App\Models\CustomField::Where('customfields_type', 'leads')->where('customfields_status', 'enabled')->get(),
        ];
    ...
    public function show(
        ...
        $tags_user = $this->tagrepo->getByType('lead');
