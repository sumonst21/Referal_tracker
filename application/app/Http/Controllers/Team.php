...
class Team extends Controller {
    ...
    public function store() {
        ...
        $user->notifications_projects_activity = config('settings.default_notifications_team.notifications_projects_activity');
        $user->notifications_billing_activity = config('settings.default_notifications_team.notifications_billing_activity');
        $user->notifications_new_assignement = config('settings.default_notifications_team.notifications_new_assignement');
        $user->notifications_leads_activity = config('settings.default_notifications_team.notifications_leads_activity');
        $user->notifications_tasks_activity = config('settings.default_notifications_team.notifications_tasks_activity');
        $user->notifications_tickets_activity = config('settings.default_notifications_team.notifications_tickets_activity');
        $user->notifications_system = config('settings.default_notifications_team.notifications_system');
