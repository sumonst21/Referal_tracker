...
class Clients extends Controller {
    ...
    public function __construct(UserRepository $userrepo, ClientRepository $clientrepo, TagRepository $tagrepo) {
    ...
    public function create() {
        ...
        $payload = [
            'page' => $page,
            'tags' => $tags,
            'fields' => \App\Models\CustomField::Where('customfields_type', 'clients')->where('customfields_status', 'enabled')->get(),
        ];
        //show the form
