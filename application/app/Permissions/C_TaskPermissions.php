...
class C_TaskPermissions {
     ...
     */
    public function check($action = '', $task = '') {
        ...
        if ($task instanceof \App\Models\C_Task || $task instanceof \Illuminate\Pagination\LengthAwarePaginator) {
