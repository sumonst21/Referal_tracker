...
class Kernel extends ConsoleKernel {
    ...
    protected function schedule(Schedule $schedule) {
        ...
        $schedule->call(new \App\Cronjobs\Paypal\OnetimePayment)->everyMinute();

        //process webhooks for stripe onetime payments
        $schedule->call(new \App\Cronjobs\Stripe\OnetimePayment)->everyMinute();
        ...
        //process webhooks for razorpay onetime payments
        $schedule->call(new \App\Cronjobs\Razorpay\OnetimePayment)->everyMinute();
