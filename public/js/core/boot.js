...
function nxTinyMCEBasic(tinyMCEHeight = 300, tinyMCESelector = '.tinymce-textarea') {
    ...
    tinymce.init({
        ...
        toolbar: 'bold link bullist numlist image alignleft aligncenter alignright blockquote fullscreen',
 ...
 * ---------------------------------------------------------*/
function nxTinyMCEAdvanced(tinyMCEHeight = 300, tinyMCESelector = '.tinymce-textarea', plugins = '', toolbar = '') {
